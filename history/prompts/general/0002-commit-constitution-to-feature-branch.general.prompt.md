...
feature: none
branch: docs/add-constitution-research-paper
...
- history/prompts/constitution/0001-add-constitution-for-research-paper.constitution.prompt.md
tests:
...
<command-args>Commit the constitution to a feature branch</command-args>Your task is to intelligently executes git workflows to commit the work and create PR following your Principles
